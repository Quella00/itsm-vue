	            ...
	            <div class="tabs-panel-wrap border">
	                ...
	                <div class="panel-body">
	                	<!--<div style="margin-bottom:30px; height:500px; width:100%;">
	                		<div class="echarts-line-maintenanceGroup" id="echarts-line-maintenanceGroup" style="width:100%; height:100%;"></div>
	                	</div>-->
	                	<div class="echarts-container">
	                		<div v-if="!configSynthesisData.echart.isShow" class="echarts-nodata-tips">无运维组工单数据，无法形成报表</div>
	                		<div class="echarts-line-maintenanceGroup" id="echarts-line-maintenanceGroup" style="width:100%; height:100%;"></div>
	                	</div>
...
export default {
	...
	data() {
		return {
			...
			// 运维组工单报表数据
			configSynthesisData: {
				reportType: 'maintenanceGroup',   // 报表类型
...
//			this.configSynthesisData.form.data.endTime = startTimeAndEndTimeObj.endTime;
			...
			this.$axios.post('/itsm/performance/manager/workOrdeReportForm/queryOperation', this.configSynthesisData.echart.params).then((res) => {
				if(res.status == 200 && res.data && res.data.length) {
					...
					echartLine('echarts-line-maintenanceGroup', xAxisData, yAxisData, dataColor);
				}else{
